...
const MarktplaetzePage = () => {
  ...
  const additionalPlatforms = [
    ...
    { name: "Douglas", category: "Beauty", logo: "https://customer-assets.emergentagent.com/job_marketplace-hub-107/artifacts/4q6h6la7_douglass.jpg", size: "h-15" },
              ...
              >
                {platform.logo ? (
                  <img 
                    ...
                    className={`${platform.size || 'h-14'} mx-auto mb-3 object-contain`}
                  />
                ) : (
